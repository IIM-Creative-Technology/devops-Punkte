...
export class ChannelService {
  ...
  async findAll(getChannelsQuery: GetChannelsQuery) {
    ...
    const yolo1 = await channels.getMany();
    const yolo = yolo1.map((a, i) => ({
      title: a.title,
    ...
    return [
      ...
      [yolo[0], yolo[12], yolo[15]],
      [yolo[44], yolo[39], yolo[19]],
      [yolo[39], yolo[49], yolo[6]],
      [yolo[0], yolo[44], yolo[6]],
      [yolo[25], yolo[6], yolo[15]],
      [yolo[37], yolo[33], yolo[24]],
      [yolo[33], yolo[10], yolo[49]],
      [yolo[18], yolo[33], yolo[35]],
